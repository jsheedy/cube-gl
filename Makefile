...
model-scene: model-scene.cpp model.hpp objects.hpp scene.hpp osc.hpp osc.cpp shader.h shaders/brain-glow.vs shaders/brain-glow.fs shaders/geometry.vs shaders/geometry.fs shaders/geometry.gs
